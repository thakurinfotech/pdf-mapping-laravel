...
<html lang="en">
  <head>
	...
	<!-- Favicon icon -->
	<link rel="icon" href="{{ asset('assets-landing/logos/favicon.ico') }}" type="image/png" sizes="16x16">
	<!-- Bootstrap -->
    <link href="{{ asset('assets-landing/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" media="all" />
	<!-- Font -->
	...
	<!-- Main Style css -->
    <link href="{{ asset('assets-landing/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
  </head>
  <body>
        ...
        <div class="container">
          ...
          <div class="navbar-header page-scroll">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand page-scroll" href="#main"><img src="{{ asset('assets-landing/logos/logo.png') }}" alt="Gradient Able Logo" /></a>
              </div>
        ...
        <div class="container">
          <div class="hero-content app-hero-content text-center">
            <div class="col-md-10 col-md-offset-1 nopadding">
                <h1 class="wow fadeInUp" data-wow-delay="0s">Gradient Able Bootstrap 4 Admin Template</h1>
                <p class="wow fadeInUp" data-wow-delay="0.2s">
                  First ever Bootstrap 4 admin template with Gradient UI Interface. <br class="hidden-xs"> Its best choice for your any complex project.
                </p>
          ...
          <div class="col-md-12">
            <div class="hero-image">
              <img class="img-responsive" src="{{ asset('assets-landing/images/app_hero_1.png') }}" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="services-section text-center" id="services"><!-- Services section (small) with icons -->
        <div class="container">
          ...
          <div class="services-content">
            ...
            <p class="wow fadeInUp" data-wow-delay="0.2s">
              Gradient Able is one of the finest Admin dashboard template in its category. Premium admin dashboard with high end feature rich possibilities.
            </p>
          </div>
        </div>
          ...
          <div class="services">
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
              <div class="services-icon">
                <img src="{{ asset('assets-landing/logos/icon1.png') }}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
                <h1>Mega feature rich</h1>
                <p>
                  Gradient Able is one of unique dashboard template which come with tons of ready to use feature. We continuous working on it to provide latest updates in digital market.
                </p>
              </div>
            </div>
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
              <div class="services-icon">
                <img class="icon-2" src="{{ asset('assets-landing/logos/icon2.png') }}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
                <h1>Fast and Robust</h1>
                <p>
                  We are contantly working on Gradient Able and improve its performance too. Your definitely give higher rating to Gradient Able for its performance.
                </p>
              </div>
            </div>
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
              <div class="services-icon">
                <img class="icon-3" src="{{ asset('assets-landing/logos/icon3.png') }}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
  ...
  <div class="flex-features" id="features">
      ...
      <div class="flex-split"><!-- Feature section with flex layout -->
        <div class="f-left wow fadeInUp" data-wow-delay="0s">
          <div class="left-content">
            <img class="img-responsive" src="{{ asset('assets-landing/images/feature_1.png') }}" alt="" />
          </div>
        </div>
        <div class="f-right wow fadeInUp" data-wow-delay="0.2s">
          <div class="right-content">
            ...
            <p>
              Gradient Able is full flexible solution for your entire project development. You can easily maintain all of its module/components.
            </p>
            <ul>
      ...
      <div class="flex-split"><!-- Feature section with flex layout -->
        ...
        <div class="f-left">
          <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
            <img class="img-responsive" src="{{ asset('assets-landing/images/feature_2.png') }}" alt="" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row text-center">
          ...
          <!--  <h1>Destiny is loved by many Startups.</h1>
            ...
            <div class="testimonials owl-carousel owl-theme">
              <div class="testimonial-single"><img class="img-circle" src="{{ asset('assets-landing/images/testimonial2.jpg') }}" alt="Client Testimonoal" />
              ...
              <div class="testimonial-single"><img class="img-circle" src="{{ asset('assets-landing/images/testimonial1.jpg') }}" alt="Client Testimonoal" />
              ...
              <div class="testimonial-single"><img class="img-circle" src="{{ asset('assets-landing/images/testimonial3.jpg') }}" alt="Client Testimonoal" />
                <div class="testimonial-text">
    ...
    <!-- Feature Image Big -->
      <div class="feature_huge text-center">
        <div class="container nopadding">
          <div class="col-md-12">
            <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s" src="{{ asset('assets-landing/images/big_feature.png') }}" alt="" style="max-width:100%"/>
          </div>
          <div class="feature_list">
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
              <img src="{{ asset('assets-landing/logos/feature_icon.png') }}" alt="Feature" />
            ...
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
              <img src="{{ asset('assets-landing/logos/feature_icon_2.png') }}" alt="Feature" />
            ...
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
              <img src="{{ asset('assets-landing/logos/feature_icon_3.png') }}" alt="Feature" />
      ...
      <div class="f-left">
        <div class="left-content wow fadeInLeft" data-wow-delay="0s">
          ...
          <p class="wow fadeInLeft" data-wow-delay="0.2s">
            We at Gradient Able available for custom work development with High end specialized developer.
          </p>
        ...
        <div class="col-md-12 col-sm-12 nopadding">
          ...
          <div class="col-sm-6 nopadding">
            <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon">
                <img src="{{ asset('assets-landing/logos/cart2.png') }}" alt="Icon" />
              </div>
          ...
          <div class="col-sm-6 nopadding">
            <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
              <div class="icon">
                <img src="{{ asset('assets-landing/logos/cart1.png') }}" alt="Icon" />
              </div>
              <div class="pricing-details">
                <h2>Premium Plan</h2>
                <span>$19.99</span>
  ...
  <div class="client-section">
    <div class="container text-center">
      <div class="clients owl-carousel owl-theme">
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo1.png') }}" alt="" />
        </div>
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo2.png') }}" alt="" />
        </div>
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo3.png') }}" alt="" />
        </div>
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo4.png') }}" alt="" />
        </div>
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo6.png') }}" alt="" />
        </div>
        <div class="single">
          <img src="{{ asset('assets-landing/logos/logo7.png') }}" alt="" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="cta-sub text-center no-color">
    <div class="container">
      ...
      <div class="form wow fadeInUp" data-wow-delay="0.3s">
        <form class="subscribe-form wow zoomIn" action="{{ asset('assets-landing/php/subscribe.php') }}" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate>
...
<!-- Footer Section -->
  <div class="footer">
    <div class="container">
        <div class="col-md-12 text-center">
          <img src="{{ asset('assets-landing/logos/logo.png') }}" alt="Gradient Able Logo" />
        ...
        <div class="footer-text">
          <p>
            Copyright © 2017 Gradient Able. All Rights Reserved.
          </p>
        </div>
      </div>
      </div>
...
<!-- Jquery and Js Plugins -->
  <script  src="{{ asset('assets-landing/js/jquery-2.1.1.js') }}"></script>
  <script  src="{{ asset('assets-landing/js/bootstrap.min.js') }}"></script>
  <script  src="{{ asset('assets-landing/js/plugins.js') }}"></script>
  <script  src="{{ asset('assets-landing/js/menu.js') }}"></script>
